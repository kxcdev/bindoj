...
const srcdir = "../../example/for_dev/apidir_examples/typescript-metainfo";

export const getStaticPaths = async () => {
  const docs = [
    ...getAllDocs(srcdir, ".ts").map<[string, Doc]>(doc => ["", doc]),
  ];
  console.log("dt.getStaticPaths docs:", docs.map(([prefix, doc]) => prefix + doc.filename));
  return {
...
export const getStaticProps = async ({ params }: any) => {
  console.log("dt.getStaticProps docs:", params);
