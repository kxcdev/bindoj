...
module Full_bridge_with_jsoo : Endemic_setup_only_full_bridge = functor (M :
  sig
    val my_string : string
    val my_hello : hello
    val my_sole_var : sole_var
  ...
  struct
    ...
    let unwrap_endemic (Bindoj_objintf_shared.Endemic_object
      { bridge = Br; underlying }) = underlying[@@warning "-32"]
    ...
    and encode_unit_sole_to_js (__caml_obj : unit_sole) =
      Js_of_ocaml.Js.Unsafe.callback
        (fun __arg0 ->
           encode_string_to_js
             (__caml_obj (decode_string_of_js __arg0) () ()))[@@warning
                                                               "-39"]
      ...
      let open Js_of_ocaml.Js in
        Unsafe.obj
          [|("name",
              (Unsafe.inject
                 (Unsafe.callback
                    (fun () -> encode_string_to_js (__caml_obj#name )))));
            ("unit01",
              (Unsafe.inject
                 (Unsafe.callback
                    (fun __arg0 ->
                                               ...
                                               encode_string_to_js
                                                 (__caml_obj#unit_03
                                                    (decode_string_of_js
                                                       __arg0) () () ())))))|]
    [@@warning "-39"]
    and encode_unit_mod_to_js ((module M)  : (module unit_mod)) =
      let open Js_of_ocaml.Js in
        Unsafe.obj
          [|("name",
              (Unsafe.inject
    ...
    [@@warning "-39"]
    and encode_with_default_value_to_js
      ((module M)  : (module with_default_value)) =
      let open Js_of_ocaml.Js in
        Unsafe.obj
          [|("getDefaultString",
              (Unsafe.inject
                    ...
                    (fun labeledArgs ->
                       encode_string_to_js
                         (M.get_default_string
                            ~str:((let open Js_of_ocaml.Js in
                    ...
                    (fun labeledArgs ->
                       encode_string_to_js
                         (M.get_default_student
                            ~student:((let open Js_of_ocaml.Js in
                                         (Optdef.bind labeledArgs
                                            (fun la ->
                                               Optdef.map
    ...
    let rec encode_sole_var_to_js (__caml_obj : sole_var) =
      Js_of_ocaml.Js.Unsafe.callback
        (fun () -> encode_string_to_js (__caml_obj ))[@@warning "-39"]
                 ...
                 (Unsafe.callback
                    (fun () ->
                       (fun x -> encode_rec_obj_to_js (unwrap_endemic x))
                         (__caml_obj#get_self )))))|][@@warning "-39"]
                           ...
                           Js.Unsafe.set
                             ...
                             (let open Js_of_ocaml.Js in
                                Unsafe.obj
                                  [|("myString",
                                      (Unsafe.inject
                                         (encode_string_to_js M.my_string)));
                                    ("myHello",
                                      (Unsafe.inject
                                         (encode_hello_to_js M.my_hello)));
                                    ("mySoleVar",
                                      (Unsafe.inject
                                         (encode_sole_var_to_js M.my_sole_var)));
                                    ("myUnitSole",
                                      (Unsafe.inject
                                         (encode_unit_sole_to_js
                                            M.my_unit_sole)));("myUnitObj",
                                                                (Unsafe.inject
                                                                   (encode_unit_obj_to_js
                                                                    M.my_unit_obj)));
                                    ("myUnitMod",
                                      (Unsafe.inject
                                         (encode_unit_mod_to_js M.my_unit_mod)));
                                    ("myRecObj",
                                      (Unsafe.inject
                                         (encode_rec_obj_to_js M.my_rec_obj)));
                                    ("myNonJsonValues",
                                      (Unsafe.inject
                                         ((let open Utils in
                                             encode_non_json_values_to_js)
                                            M.my_non_json_values)));("withDefaultValue",
                                                                    (Unsafe.inject
