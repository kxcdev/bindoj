...
module type Concrete_bridge  =
  sig
    ...
    sig 
      (** my_logger object *)
      val my_logger : (module Logger) peer end
...
module Full_bridge_with_jsoo : Dual_setup_full_bridge = functor (M :
  sig
                     ...
                     (fun
                        ...
                        (let concrete_bridge = ((module
                           struct
                             ...
                             [@@warning "-32"]
                             and encode_int_to_js = float_of_int[@@warning
                                                                  "-32"]
                             ...
                             and decode_int_of_js jv =
                               if Float.is_integer jv
                               then int_of_float jv
                               else
                                 Format.kasprintf failwith
                                   "expecting an integer but the given is '%f'"
                                   jv[@@warning "-32"]
                               ...
                               let open Js_of_ocaml in
                                 let decoder =
                                   Js.Unsafe.new_obj
                                     ...
                                     [||] in
                                 fun jv ->
                                   ((Js.Unsafe.meth_call decoder "decode"
                                       [|jv|])
                                      |> Js.to_string)
                                     |> Bytes.of_string[@@warning "-32"]
                             let rec byte_source_state_of_json' =
                               (fun ?(path= []) ->
                                  fun x ->
                                    ((let rec of_json_impl =
                                        let bytes_of_json' path =
                                          function
                                          | (`str x : Kxclib.Json.jv) ->
                                              (try
                                                 Ok (Kxclib.Base64.decode x)
                                               with
                                        ...
                                        fun path ->
                                          fun __bindoj_orig ->
                                            match Kxclib.Jv.pump_field "kind"
                                                    __bindoj_orig
                                            with
                                            | `obj
                                                (("kind", `str "data")::param)
                                                ->
                                                (match List.assoc_opt "value"
                                                         param
                                                 with
                                                 | Some (`arr (x0::x1::[]))
                                                     ->
                                                           ...
                                                           ((fun path ->
                                                               ...
                                                               | `str s ->
                                                                   ((function
                                                                    ...
                                                                    Error
                                                                    ((Printf.sprintf
                                                                    "given string '%s' is not one of [ 'eof', 'maybe-more' ]"
                                                                    s), path)))
                                                                    s
                                                               | jv ->
                                                                   Error
                                                 ...
                                                 | Some (`arr xs) ->
                                                     Error
                                                       ((Printf.sprintf
                                                           "expecting an array of length 2, but the given has a length of %d"
                                                           (List.length xs)),
                                                         ((`f "value") ::
                                                         path))
                                                 | Some jv ->
                                                 ...
                                                 | None ->
                                                     Error
                                                       ("mandatory field 'value' does not exist",
                                                         path))
                                            | `obj (("kind", `str "wait")::_)
                                                -> Ok `wait
                                            | `obj (("kind", `str "eof")::_)
                                            ...
                                            | `obj
                                                (("kind",
                                                  `str discriminator_value)::_)
                                                ->
                                                Error
                                                  ((Printf.sprintf
                                                      "given discriminator field value '%s' is not one of [ 'data', 'wait', 'eof' ]"
                                                      discriminator_value),
                                                    ((`f "kind") :: path))
                                            | `obj (("kind", jv)::_) ->
                                                Error
                                            ...
                                            | `obj _ ->
                                                Error
                                                  ("discriminator field 'kind' does not exist",
                                                    path)
                                            | jv ->
                                                Error
                                                  ((Printf.sprintf
                               ...
                               | `wait  | `eof ]
                                 Bindoj_runtime.json_full_decoder)[@@warning
                                                                    "-39"]
                                             ...
                                             (fun labeledArgs ->
                                                encode_bytes_to_js
                                                  (__caml_obj#next_block
                                                     ...
                                                     ())))))|][@@warning
                                                                "-39"]
                             and encode_Logger_to_js
                               ((module M)  : (module Logger)) =
                               let open Js_of_ocaml.Js in
                                 Unsafe.obj
                                   [|("info",
                                       (Unsafe.inject
                                          ...
                                          (Unsafe.callback_with_arity 2
                                             (fun __arg0 ->
                                                fun labeledArgs ->
                                                  encode_unit_to_js
                                                    (M.error
                                                       ?exn:(let open Js_of_ocaml.Js in
                                                               (Optdef.bind
                                                                  labeledArgs
                                                                  (fun la ->
                                                                    Optdef.map
                                                       ...
                                                       (decode_string_of_js
                                                          __arg0))))))|]
                             [@@warning "-39"]
                             and decode_Logger_of_js __js_obj = ((module
                               struct
                                 let info __arg0 =
                                   let open Js_of_ocaml in
                                     decode_unit_of_js
                                                ...
                                                encode_unit_to_js
                                                  (__caml_obj#write_async
                                                     ((wrap_peer
                                                        ...
                                                        __arg0))))))|]
                             [@@warning "-39"]
                             and encode_System_io_to_js
                               ((module M)  : (module System_io)) =
                               let open Js_of_ocaml.Js in
                                 Unsafe.obj
                                   [|("stdout",
                                       (Unsafe.inject
                                             ...
                                             (fun labeledArgs ->
                                                (fun x ->
                                                   encode_output_channel_to_js
                                                     (unwrap_endemic x))
                                                  (M.open_file_wo
                                                     ~path:(let open Js_of_ocaml.Js in
                                                              decode_string_of_js
                                                                (Unsafe.get
                                                                   labeledArgs
                                                                   "path")))))));
                             ...
                             module Endemic_object_registry =
                               struct
                                 open Bindoj_runtime
                                 let registry_of_logger = ref StringMap.empty
                             ...
                             let () =
                                                  ...
                                                  (Unsafe.callback
                                                     (fun coordinate ->
                                                        (lookup_logger
                                                           ...
                                                           ~variant:(
                                                           (fun jv ->
                                                              match Js_of_ocaml.Js.to_string
                                                                    jv
                                                              with
                                                              | "persistent"
                                                                  ->
                                                              ...
                                                              | s ->
                                                                  Format.kasprintf
                                                                    failwith
                                                                    "given string '%s' is not one of [ 'persistent', 'transient' ]"
                                                                    s)
                                                             (Js.Unsafe.get
                                                                coordinate
                                                                "variant")))
                               ...
                               (let open Js_of_ocaml in
                                  Js.Unsafe.set
                                    (Js.Unsafe.get peer_full_bridge
                                       "instance") "peerObjects"
                                    (let open Js_of_ocaml.Js in
                                       Unsafe.obj
                                         [|("systemIo",
                                             (Unsafe.inject
                                                (encode_System_io_to_js
                                                   M.system_io)))|]))
                           end) : (module Bridge)) in
                         concrete_bridge |>
                           ((fun (module B)  ->
                               M.initially_registry_objects (module
                                 B.Endemic_object_registry)));
