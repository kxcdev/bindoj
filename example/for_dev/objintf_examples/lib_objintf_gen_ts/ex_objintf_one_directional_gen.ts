...
export type ConcreteBridge = { readonly peerObjectRegistry : { readonly lookupString : (coordinate : { readonly id0 : string, readonly id1 : number }) => string
| (null), readonly lookupHello : (coordinate : { readonly id : string }) => (bindoj.peer<Hello>)
| (null) }, readonly peerObjects : { readonly myString : string, readonly myHello : bindoj.peer<Hello>, readonly mySoleVar : bindoj.peer<Interfaces.SoleVar>, readonly myUnitSole : bindoj.peer<UnitSole>, readonly myUnitObj : bindoj.peer<UnitObj>, readonly myUnitMod : bindoj.peer<UnitMod>, readonly myRecObj : bindoj.peer<Interfaces.RecObj>, readonly myNonJsonValues : NonJsonValues, readonly withDefaultValue : bindoj.peer<WithDefaultValue> } }
export type FullBridge_peerSetupOnly = { readonly bridgeAsync : Promise<ConcreteBridge>, readonly getBridge : () => ConcreteBridge
